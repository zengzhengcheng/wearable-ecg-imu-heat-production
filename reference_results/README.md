...
- `formal_window_predictions.csv`: 4,079 formal test-pig windows. `predicted_HP_raw` supports the all-stage R² = 0.675 and 2,470-window follow-up R² = 0.710; `predicted_HP_calibrated` supports fixed-alpha R² = 0.800.
